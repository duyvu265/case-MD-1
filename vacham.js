...
let p1 = new vacham(a.style.left, a.style.top);
let p2 = new vacham(b.style.left, b.style.top);
let p3 = new vacham(c.style.left, c.style.top);
let p4 = new vacham(d.style.left, d.style.top);

let p5 = new vacham(e.style.left, e.style.top);
let p6 = new vacham(f.style.left, f.style.top);
let p7 = new vacham(g.style.left, g.style.top);
...
if (checkvacham(c1||c2||c3||c4||c5||c6||c7 ,superr)) {
    alert("thua cuoc");
